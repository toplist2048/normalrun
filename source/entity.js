...
class entity_t {
	...
	_update() {
		...
		// velocity
		t.vx += t.ax * time_elapsed - t.vx * Math.min(t.f * time_elapsed, 1);
		t.vy += t.ay * time_elapsed - t.vy * Math.min(t.f * time_elapsed, 1);
		t.vz += t.az * time_elapsed - t.vz * Math.min(t.f * time_elapsed, 1);
	...
	_render() { // render
		var t = this;
		//if (this instanceof entity_player_t) {
		//	console.log(t.x + " "+ t.y + " "+t.z + " "+ t.s);
		//}
		_gl.push_sprite(t.x, t.y, t.z, t.s);
	}
}
